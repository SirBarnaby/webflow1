...
(() => {
    ...
    var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        Ls = (e, t, r, n) => {
            if ((t && typeof t == "object") || typeof t == "function") for (let i of Y_(t)) !Q_.call(e, i) && i !== r && nn(e, i, { get: () => t[i], enumerable: !(n = K_(t, i)) || n.enumerable });
            return e;
        };
    var le = (e, t, r) => ((r = e != null ? z_($_(e)) : {}), Ls(t || !e || !e.__esModule ? nn(r, "default", { value: e, enumerable: !0 }) : r, e)),
    ...
    var Li = c(() => {
        ...
        window.tram = (function (e) {
            ...
            function u(l, _, A) {
                ...
                var S = A;
                return Fe.test(l) || !He.test(l) ? (S = parseInt(l, 10)) : He.test(l) && (S = 1e3 * parseFloat(l)), 0 > S && (S = 0), S === S ? S : A;
            }
            function f(l) {
            ...
            var g = (function (l, _, A) {
                    ...
                    function Z(ie, ve) {
                        ...
                        return (
                            (tt.constructor = U),
                                ...
                                (U.open = function (Re) {
                                    if (((se = {}), T(Re) ? (se = Re.call(U, tt, be, U, ie)) : S(Re) && (se = Re), S(se))) for (var mr in se) _.call(se, mr) && (tt[mr] = se[mr]);
                ...
                v = {
                    ease: [
                        ...
                        function (l, _, A, S) {
                            var T = (l /= S) * l,
                                L = T * l;
                            return _ + A * (-2.75 * L * T + 11 * T * T + -15.5 * L + 8 * T + 0.25 * l);
                        },
                    ],
                    "ease-in": [
                        "ease-in",
                    ...
                    "ease-out": [
                        ...
                        function (l, _, A, S) {
                            var T = (l /= S) * l,
                                L = T * l;
                            return _ + A * (0.3 * L * T + -1.6 * T * T + 2.2 * L + -1.8 * T + 1.9 * l);
                        },
                    ],
                    "ease-in-out": [
                        "ease-in-out",
                    ...
                    "ease-in-out-quad": [
                        ...
                        function (l, _, A, S) {
                            return (l /= S / 2) < 1 ? (A / 2) * l * l + _ : (-A / 2) * (--l * (l - 2) - 1) + _;
                        },
                    ],
                    "ease-in-cubic": [
                    ...
                    "ease-in-out-cubic": [
                        ...
                        function (l, _, A, S) {
                            return (l /= S / 2) < 1 ? (A / 2) * l * l * l + _ : (A / 2) * ((l -= 2) * l * l + 2) + _;
                        },
                    ],
                    "ease-in-quart": [
                    ...
                    "ease-in-out-quart": [
                        ...
                        function (l, _, A, S) {
                            return (l /= S / 2) < 1 ? (A / 2) * l * l * l * l + _ : (-A / 2) * ((l -= 2) * l * l * l - 2) + _;
                        },
                    ],
                    "ease-in-quint": [
                    ...
                    "ease-in-out-quint": [
                        ...
                        function (l, _, A, S) {
                            return (l /= S / 2) < 1 ? (A / 2) * l * l * l * l * l + _ : (A / 2) * ((l -= 2) * l * l * l * l + 2) + _;
                        },
                    ],
                    "ease-in-sine": [
                    ...
                    "ease-out-expo": [
                        ...
                        function (l, _, A, S) {
                            return l === S ? _ + A : A * (-Math.pow(2, (-10 * l) / S) + 1) + _;
                        },
                    ],
                    "ease-in-out-expo": [
                        "cubic-bezier(1, 0, 0, 1)",
                        function (l, _, A, S) {
                            return l === 0 ? _ : l === S ? _ + A : (l /= S / 2) < 1 ? (A / 2) * Math.pow(2, 10 * (l - 1)) + _ : (A / 2) * (-Math.pow(2, -10 * --l) + 2) + _;
                        },
                    ],
                    "ease-in-circ": [
                    ...
                    "ease-in-out-circ": [
                        ...
                        function (l, _, A, S) {
                            return (l /= S / 2) < 1 ? (-A / 2) * (Math.sqrt(1 - l * l) - 1) + _ : (A / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + _;
                        },
                    ],
                    "ease-in-back": [
                        "cubic-bezier(0.600, -0.280, 0.735, 0.045)",
                        function (l, _, A, S, T) {
                            return T === void 0 && (T = 1.70158), A * (l /= S) * l * ((T + 1) * l - T) + _;
                        },
                    ],
                    "ease-out-back": [
                        "cubic-bezier(0.175, 0.885, 0.320, 1.275)",
                        function (l, _, A, S, T) {
                            return T === void 0 && (T = 1.70158), A * ((l = l / S - 1) * l * ((T + 1) * l + T) + 1) + _;
                        },
                    ],
                    "ease-in-out-back": [
                        "cubic-bezier(0.680, -0.550, 0.265, 1.550)",
                        function (l, _, A, S, T) {
                            return T === void 0 && (T = 1.70158), (l /= S / 2) < 1 ? (A / 2) * l * l * (((T *= 1.525) + 1) * l - T) + _ : (A / 2) * ((l -= 2) * l * (((T *= 1.525) + 1) * l + T) + 2) + _;
                        },
                    ],
                },
                ...
                H = function (l) {
                    ...
                    var _,
                        ...
                        S = "",
                        T = l.split("-");
                    for (_ = 0; _ < T.length; _++) S += T[_].charAt(0).toUpperCase() + T[_].slice(1);
                    for (_ = 0; _ < x.length; _++) if (((A = x[_] + S), A in k.style)) return { dom: A, css: M[_] + l };
                },
                B = (t.support = { bind: Function.prototype.bind, transform: H("transform"), transition: H("transition"), backface: H("backface-visibility"), timing: H("transition-timing-function") });
            if (B.transition) {
                var ee = B.timing.dom;
                if (((k.style[ee] = v["ease-in-back"][0]), !k.style[ee])) for (var ne in m) v[ne][0] = m[ne];
            }
            var D = (t.frame = (function () {
                ...
                d = g(function (l) {
                    function _(te, ce) {
                        ...
                        if (!ce.weak || !this.props[de]) {
                            var je = Le[0],
                                Me = this.props[de];
                            return Me || (Me = this.props[de] = new je.Bare()), Me.init(this.$el, me, Le, ce), Me;
                        }
                    }
                    function A(te, ce, me) {
                        if (te) {
                            var de = typeof te;
                            if ((ce || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), de == "number" && ce)) return (this.timer = new ue({ duration: te, context: this, complete: L })), void (this.active = !0);
                            if (de == "string" && ce) {
                                switch (te) {
                                    case "hide":
                                        U.call(this);
                            ...
                            if (de == "object") {
                                ...
                                tt.call(
                                    ...
                                    be.call(this),
                                Le > 0 && ((this.timer = new ue({ duration: Le, context: this })), (this.active = !0), ce && (this.timer.complete = L));
                                var je = this,
                                    Me = !1,
                                    rn = {};
                                D(function () {
                    ...
                    function S(te) {
                        (te = u(te, 0)), this.active ? this.queue.push({ options: te }) : ((this.timer = new ue({ duration: te, context: this, complete: L })), (this.active = !0));
                    }
                    function T(te) {
                        return this.active ? (this.queue.push({ options: te, args: arguments }), void (this.timer.complete = L)) : f("No active transition timer. Use start() or wait() before then().");
                    }
                    function L() {
                    ...
                    function Z(te) {
                        ...
                        var ce;
                        typeof te == "string" ? ((ce = {}), (ce[te] = 1)) : (ce = typeof te == "object" && te != null ? te : this.props), tt.call(this, ce, Re), be.call(this);
                    }
                    function ie(te) {
                    ...
                    function be() {
                        ...
                        for (te in this.props) (ce = this.props[te]), ce.active && me.push(ce.string);
                        (me = me.join(",")), this.style !== me && ((this.style = me), (this.el.style[B.transition.dom] = me));
                    }
                    function tt(te, ce, me) {
                        var de,
                            ...
                            rn = ce !== Re,
                            Te = {};
                        for (de in te) (je = te[de]), de in fe ? (Te.transform || (Te.transform = {}), (Te.transform[de] = je)) : (N.test(de) && (de = r(de)), de in V ? (Te[de] = je) : (Me || (Me = {}), (Me[de] = je)));
                        for (de in Te) {
                    ...
                    (l.init = function (te) {
                        ...
                        B.backface && oe.hideBackface && p(this.el, B.backface.css, "hidden");
                    }),
                        Xe("add", _),
                        Xe("start", A),
                        Xe("wait", S),
                    ...
                    (l.init = function (L, Z, ie, ve) {
                        ...
                        Y[U] && (U = Y[U]),
                            ...
                            oe.fallback || ve.fallback
                                ...
                                : ((this.animate = this.transition), (this.string = this.name + re + this.duration + "ms" + (this.ease != "ease" ? re + v[this.ease][0] : "") + (this.delay ? re + this.delay + "ms" : "")));
                    }),
                        (l.set = function (L) {
                            (L = this.convert(L, this.type)), this.update(L), this.redraw();
                        }),
                        (l.transition = function (L) {
                            (this.active = !0), (L = this.convert(L, this.type)), this.auto && (this.el.style[this.name] == "auto" && (this.update(this.get()), this.redraw()), L == "auto" && (L = _.call(this))), (this.nextStyle = L);
                        }),
                        (l.fallback = function (L) {
                            var Z = this.el.style[this.name] || this.convert(this.get(), this.type);
                            (L = this.convert(L, this.type)),
                            this.auto && (Z == "auto" && (Z = this.convert(this.get(), this.type)), L == "auto" && (L = _.call(this))),
                                (this.tween = new Q({ from: Z, to: L, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
                        }),
                        (l.get = function () {
                            ...
                            switch (Z) {
                                ...
                                case q:
                                    if (U) {
                                        ...
                                        if (Z.test(L)) return L.charAt(0) == "#" && L.length == 7 ? L : S(L);
                                    }
                ...
                h = g(b, function (l, _) {
                    l.init = function () {
                        _.init.apply(this, arguments), this.original || (this.original = this.convert(this.get(), q));
                    };
                }),
                j = g(b, function (l, _) {
                    (l.init = function () {
                ...
                $ = g(b, function (l, _) {
                    function A(S, T) {
                        var L, Z, ie, ve, U;
                        for (L in S) (ve = fe[L]), (ie = ve[0]), (Z = ve[1] || L), (U = this.convert(S[L], ie)), T.call(this, Z, U, ie);
                    }
                    (l.init = function () {
                        ...
                        (l.transition = function (S) {
                            var T = this.values(S);
                            this.tween = new _e({ current: this.current, values: T, duration: this.duration, delay: this.delay, ease: this.ease });
                            var L,
                                Z = {};
                        ...
                        (l.fallback = function (S) {
                            var T = this.values(S);
                            this.tween = new _e({ current: this.current, values: T, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this });
                        }),
                        (l.update = function () {
                            p(this.el, this.name, this.style(this.current));
                        }),
                        ...
                        (l.values = function (S) {
                            ...
                            return (
                                A.call(this, S, function (Z, ie, ve) {
                                    (L[Z] = ie), this.current[Z] === void 0 && ((T = 0), ~Z.indexOf("scale") && (T = 1), (this.current[Z] = this.convert(T, ve)));
                                }),
                                    L
                            );
                        });
                ...
                Q = g(function (l) {
                    ...
                    function A() {
                        var U,
                            ...
                            se,
                            be = ie.length;
                        if (be) for (D(A), ae = z(), U = be; U--; ) (se = ie[U]), se && se.render(ae);
                    }
                    function S(U) {
                        var ae,
                            se = e.inArray(U, ie);
                    ...
                    function L(U, ae, se) {
                        return i(U[0] + se * (ae[0] - U[0]), U[1] + se * (ae[1] - U[1]), U[2] + se * (ae[2] - U[2]));
                    }
                    var Z = { ease: v.ease[1], from: 0, to: 1 };
                    (l.init = function (U) {
                        (this.duration = U.duration || 0), (this.delay = U.delay || 0);
                        var ae = U.ease || Z.ease;
                        v[ae] && (ae = v[ae][1]), typeof ae != "function" && (ae = Z.ease), (this.ease = ae), (this.update = U.update || o), (this.complete = U.complete || o), (this.context = U.context || this), (this.name = U.name);
                        var se = U.from,
                            be = U.to;
                        se === void 0 && (se = Z.from),
                        be === void 0 && (be = Z.to),
                            (this.unit = U.unit || ""),
                            typeof se == "number" && typeof be == "number" ? ((this.begin = se), (this.change = be - se)) : this.format(be, se),
                        ...
                        (l.render = function (U) {
                            ...
                            if (se < this.duration) {
                                ...
                                return (ae = this.startRGB ? L(this.startRGB, this.endRGB, be) : T(this.begin + be * this.change)), (this.value = ae + this.unit), void this.update.call(this.context, this.value);
                            }
                        ...
                        (l.format = function (U, ae) {
                            if (((ae += ""), (U += ""), U.charAt(0) == "#")) return (this.startRGB = n(ae)), (this.endRGB = n(U)), (this.endHex = U), (this.begin = 0), void (this.change = 1);
                            if (!this.unit) {
                                var se = ae.replace(O, ""),
                                    be = U.replace(O, "");
                                se !== be && s("tween", ae, U), (this.unit = se);
                            }
                            (ae = parseFloat(ae)), (U = parseFloat(U)), (this.begin = this.value = ae), (this.change = U - ae);
                        }),
                        (l.destroy = function () {
                ...
                _e = g(Q, function (l, _) {
                    (l.init = function (A) {
                        ...
                        var S, T;
                        for (S in A.values) (T = A.values[S]), this.current[S] !== T && this.tweens.push(new Q({ name: S, from: this.current[S], to: T, duration: A.duration, delay: A.delay, ease: A.ease, autoplay: !1 }));
                        this.play();
                    }),
                        (l.render = function (A) {
                            var S,
                                ...
                                Z = !1;
                            for (S = L; S--; ) (T = this.tweens[S]), T.context && (T.render(A), (this.current[T.name] = T.value), (Z = !0));
                ...
                oe = (t.config = { debug: !1, defaultUnit: "px", defaultAngle: "deg", keepInherited: !1, hideBackface: !1, perspective: "", fallback: !B.transition, agentTests: [] });
            ...
            var p = e.style,
                ...
                fe = {};
            B.transform && ((V.transform = [$]), (fe = { x: [P, "translateX"], y: [P, "translateY"], rotate: [W], rotateX: [W], rotateY: [W], scale: [R], scaleX: [R], scaleY: [R], skew: [W], skewX: [W], skewY: [W] })),
            B.transform && B.backface && ((fe.z = [P, "translateZ"]), (fe.rotateZ = [W]), (fe.scaleZ = [R]), (fe.perspective = [F]));
            var Fe = /ms/,
                He = /s|\./;
            return (e.tram = t);
        })(window.jQuery);
    ...
    var Ps = c((GU, Ns) => {
        ...
        Ns.exports = (function () {
            ...
            var t = {},
                ...
                q = Object.keys,
                F = i.bind,
                P = (e.each = e.forEach = function (x, M, H) {
                    if (x == null) return x;
                    if (y && x.forEach === y) x.forEach(M, H);
                    else if (x.length === +x.length) {
                        for (var B = 0, ee = x.length; B < ee; B++) if (M.call(H, x[B], B, x) === t) return;
                    } else for (var ne = e.keys(x), B = 0, ee = ne.length; B < ee; B++) if (M.call(H, x[ne[B]], ne[B], x) === t) return;
                    return x;
                });
            (e.map = e.collect = function (x, M, H) {
                var B = [];
                return x == null
                    ? B
                    : g && x.map === g
                ...
                (e.find = e.detect = function (x, M, H) {
                    var B;
                    return (
                ...
                (e.filter = e.select = function (x, M, H) {
                    var B = [];
                    return x == null
                        ? B
                        : w && x.filter === w
            ...
            var W = (e.some = e.any = function (x, M, H) {
                M || (M = e.identity);
                var B = !1;
                return x == null
                    ? B
            ...
            (e.contains = e.include = function (x, M) {
                return x == null
                    ? !1
                    : O && x.indexOf === O
                        ? x.indexOf(M) != -1
                ...
                (e.debounce = function (x, M, H) {
                    var B,
                        ...
                        d = function () {
                            var E = e.now() - D;
                            E < M ? (B = setTimeout(d, M - E)) : ((B = null), H || ((z = x.apply(ne, ee)), (ne = ee = null)));
                        };
                    return function () {
                        (ne = this), (ee = arguments), (D = e.now());
                        var E = H && !B;
                        return B || (B = setTimeout(d, M)), E && ((z = x.apply(ne, ee)), (ne = ee = null)), z;
                    };
                }),
            ...
            return (
                (e.template = function (x, M, H) {
                    ...
                    var B = RegExp([(M.escape || X).source, (M.interpolate || X).source, (M.evaluate || X).source].join("|") + "|$", "g"),
                        ee = 0,
                        ne = "__p+='";
...
` +
    ...
    var Be = c((VU, Us) => {
        ...
        var on = navigator.userAgent.toLowerCase(),
            ...
            nb = (pe.env.chrome = /chrome/.test(on) && /Google/.test(navigator.vendor) && parseInt(on.match(/chrome\/(\d+)\./)[1], 10)),
        ...
        pe.destroy = function (e) {
            (e = e || {}), (qi = !0), Ke.triggerHandler("__wf_destroy"), e.domready != null && (an = e.domready), ze.each(Vt, Ds), pe.resize.off(), pe.scroll.off(), pe.redraw.off(), (Ut = []), (Pi = []), Ct.state() === "pending" && Vs();
        };
        Et(pe.ready);
        Vs();
        ...
        Bs.define(
            ...
            (Ws.exports = function (e) {
                ...
                t.ready = function () {
                    ...
                    /\.webflow\.io$/i.test(w) && a.hostname !== w && (m = !0), m && !s && ((f = f || g()), v(), setTimeout(v, 500), e(r).off(u, y).on(u, y));
                };
                function y() {
                ...
                function g() {
                    var m = e('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"),
                        w = e("<img>").attr("src", "../images/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({ marginRight: "4px", width: "26px" }),
                        I = e("<img>").attr("src", "../images/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow");
                    return m.append(w, I), m[0];
                }
                function v() {
                    var m = i.children(o),
    ...
    var js = c((BU, Xs) => {
        ...
        Mi.define(
            ...
            (Xs.exports = function (e, t, r) {
                ...
                y ? f() : a.search ? (/[?&](edit)(?:[=&?]|$)/.test(a.search) || /\?edit$/.test(a.href)) && f() : i.on(s, g).triggerHandler(s);
                function g() {
                ...
                function v() {
                    (u = !0),
                        ...
                        i.off(s, g),
                        N(function (q) {
                            e.ajax({ url: O("https://editor-api.webflow.com/api/editor/view"), data: { siteId: o.attr("data-wf-site") }, xhrFields: { withCredentials: !0 }, dataType: "json", crossDomain: !0, success: m(q) });
                        });
                }
                function m(q) {
                    return function (F) {
                ...
                function w(q, F) {
                    e.ajax({ type: "GET", url: q, dataType: "script", cache: !0 }).then(F, I);
                }
                function I(q, F, P) {
                    throw (console.error("Could not load editor script: " + F), P);
                }
                function C(q) {
                    return q.indexOf("//") >= 0 ? q : O("https://editor-api.webflow.com" + q);
                }
                function O(q) {
                ...
                function N(q) {
                    ...
                    var P = function (W) {
                        W.data === "WF_third_party_cookies_unsupported" ? (R(F, P), q(!1)) : W.data === "WF_third_party_cookies_supported" && (R(F, P), q(!0));
                    };
                    (F.onerror = function () {
                        R(F, P), q(!1);
                    }),
        ...
        ub.define(
            ...
            (zs.exports = function () {
                function e(r) {
                    ...
                    function N(R) {
                        (R.target.nodeName && R.target.nodeName.toLowerCase() === "html") || ((n = !1), O());
                    }
    ...
    var ku = c((dB, Du) => {
        var Mu = ye(),
            ...
            $e,
            vn;
        Fu && (($e = Fu.split(".")), (vn = $e[0] > 0 && $e[0] < 4 ? 1 : +($e[0] + $e[1])));
        !vn && ji && (($e = ji.match(/Edge\/(\d+)/)), (!$e || $e[1] >= 74) && (($e = ji.match(/Chrome\/(\d+)/)), $e && (vn = +$e[1])));
        Du.exports = vn;
    });
    var zi = c((pB, Vu) => {
        var Gu = ku(),
    ...
    var to = c((xB, pc) => {
        ...
        pc.exports = function (e) {
            if (!cc(Ht, e) || !(lc || typeof Ht[e] == "string")) {
                var t = "Symbol." + e;
                lc && cc(Lt, e) ? (Ht[e] = Lt[e]) : dc && fc ? (Ht[e] = fc(t)) : (Ht[e] = vT(t));
            }
            return Ht[e];
        };
    });
    var yc = c((SB, hc) => {
        ...
        hc.exports = function (e, t) {
            ...
            var r = yT(e, bT),
                n;
            if (r) {
                if ((t === void 0 && (t = "default"), (n = hT(r, e, t)), !vc(n) || gc(n))) return n;
    ...
    var Bc = c((VB, Uc) => {
        var rI = Pc(),
            ...
            cI = function (e) {
                return function (t) {
                    var r;
                    if (!nI(t) || (r = Ar(t)).type !== e) throw go("Incompatible receiver, " + e + " required");
                    return r;
                };
            };
        rI || po.state
    ...
    var _l = c((tW, El) => {
        ...
        El.exports = function (e, t) {
            var r = e.target,
                ...
                f,
                y;
            if ((n ? (a = To) : i ? (a = To[r] || a0(r, {})) : (a = (To[r] || {}).prototype), a))
                for (s in t) {
                    if (((f = t[s]), e.noTargetGet ? ((y = n0(a, s)), (u = y && y.value)) : (u = a[s]), (o = u0(n ? s : r + (i ? "." : "#") + s, e.forced)), !o && u !== void 0)) {
    ...
    var Ol = c((nW, Il) => {
        ...
        Il.exports = f0
            ...
            : function (t, r) {
                p0(t);
                for (var n = v0(r), i = g0(r), o = i.length, a = 0, s; o > a; ) d0.f(t, (s = i[a++]), n[s]);
                return t;
            };
    });
    var Al = c((iW, wl) => {
    ...
    var ql = c((oW, Pl) => {
        var y0 = Or(),
            ...
            I0 = function () {
                var e = b0("iframe"),
                    t = "java" + wo + ":",
                    r;
                return (e.style.display = "none"), _0.appendChild(e), (e.src = String(t)), (r = e.contentWindow.document), r.open(), r.write(Nl("document.F=Object")), r.close(), r.F;
            },
            Tn,
            In = function () {
                try {
                ...
                In = typeof document < "u" ? (document.domain && Tn ? Rl(Tn) : I0()) : Rl(Tn);
        ...
        Pl.exports =
            ...
            function (t, r) {
                var n;
                return t !== null ? ((Io[Oo] = y0(t)), (n = new Io()), (Io[Oo] = null), (n[Ll] = t)) : (n = In()), r === void 0 ? n : m0(n, r);
            };
    });
    var Ml = c((aW, Fl) => {
        var O0 = to(),
    ...
    var Tt = c((mW, nf) => {
        ...
        function Q0(e) {
            return e == null ? (e === void 0 ? $0 : Y0) : rf && rf in Object(e) ? z0(e) : K0(e);
        }
        nf.exports = Q0;
    });
    var Co = c((EW, of) => {
    ...
    var Fo = c((Cr) => {
        ...
        function gf(e, t, r) {
            ...
            function v(I) {
                if (!(0, yO.default)(I)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            return v({ type: pf.INIT }), (n = { dispatch: v, subscribe: g, getState: y, replaceReducer: m }), (n[df.default] = w), n;
        }
    });
    var Do = c((Mo) => {
        "use strict";
            ...
            Object.keys(e).forEach(function (t) {
                ...
                if (typeof r(void 0, { type: i }) > "u")
                    throw new Error(
                        ...
                        ("Don't try to handle " + hf.ActionTypes.INIT + ' or other actions in "redux/*" ') +
    ...
    var Ze,
        ...
        Xo = he(() => {
            ...
            (Ze = {
                ...
                (HO = { CHILDREN: "CHILDREN", SIBLINGS: "SIBLINGS", IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN" }),
                (On = {
    ...
    var ke,
        ...
        wn = he(() => {
            ...
            (ke = {
                ...
                (jO = { ELEMENT: "ELEMENT", ELEMENT_CLASS: "ELEMENT_CLASS", TRIGGER_ELEMENT: "TRIGGER_ELEMENT" });
        });
    var zO,
        Tf = he(() => {
            "use strict";
    ...
    var KO,
        ...
        If = he(() => {
            "use strict";
            wn();
            ({ TRANSFORM_MOVE: KO, TRANSFORM_SCALE: YO, TRANSFORM_ROTATE: $O, TRANSFORM_SKEW: QO, STYLE_SIZE: ZO, STYLE_FILTER: JO, STYLE_FONT_VARIATION: ew } = ke),
                (jo = { [KO]: !0, [YO]: !0, [$O]: !0, [QO]: !0, [ZO]: !0, [JO]: !0, [ew]: !0 });
        });
    var Ie = {};
    De(Ie, {
    ...
    var Kt = c((Ee) => {
                ...
                if (f != null) {
                    ...
                    if (y.length)
                        for (var g = 0; g <= y.length; g++) {
                            ...
                            if (!(e && n[v] !== void 0)) {
                                var m = f[v];
                                t && An(n[v]) && An(m) && (m = Ve(e, t, n[v], m)), !(m === void 0 || m === n[v]) && (i || ((i = !0), (n = xn(n))), (n[v] = m));
                            }
                        }
                }
            }
        ...
        function Wf(e, t, r, n, i, o, a) {
            var s = Sn(e, t);
            s == null && (s = {});
            for (var u = void 0, f = arguments.length, y = Array(f > 7 ? f - 7 : 0), g = 7; g < f; g++) y[g - 7] = arguments[g];
            return y.length ? (u = Ve.call.apply(Ve, [null, !1, !1, s, r, n, i, o, a].concat(y))) : (u = Ve(!1, !1, s, r, n, i, o, a)), Rn(e, t, u);
        }
        function Hf(e, t) {
    ...
    var zf,
        ...
        Yf = he(() => {
            ...
            Ge();
            (zf = le(Kt())),
                ({ IX2_PREVIEW_REQUESTED: xA, IX2_PLAYBACK_REQUESTED: SA, IX2_STOP_REQUESTED: CA, IX2_CLEAR_REQUESTED: RA } = Ie),
                (LA = { preview: {}, playback: {}, stop: {}, clear: {} }),
                (jf = Object.create(null, { [xA]: { value: "preview" }, [SA]: { value: "playback" }, [CA]: { value: "stop" }, [RA]: { value: "clear" } })),
                (Kf = (e = LA, t) => {
                    if (t.type in jf) {
                        let r = [jf[t.type]];
    ...
    var Ne,
        ...
        Zf = he(() => {
            ...
            (Ne = le(Kt())),
                ...
                ($f = { active: !1, tick: 0, eventListeners: [], eventState: {}, playbackState: {}, viewportWidth: 0, mediaQueryKey: null, hasBoundaryNodes: !1, hasDefinedMediaQueries: !1, reducedMotion: !1 }),
                (BA = 20),
                (Qf = (e = $f, t) => {
                    switch (t.type) {
                        case NA: {
    ...
    var Xd = c((O5, Hd) => {
        ...
        function sS(e, t) {
            var r = this.__data__;
            return (this.size += this.has(e) ? 0 : 1), (r[e] = oS && t === void 0 ? aS : t), this;
        }
        Hd.exports = sS;
    });
    var zd = c((w5, jd) => {
    ...
    var $d = c((A5, Yd) => {
        var Kd = zd(),
            ...
            vS = Nn();
        function gS() {
            (this.size = 0), (this.__data__ = { hash: new Kd(), map: new (vS || pS)(), string: new Kd() });
        }
        Yd.exports = gS;
    });
    var Zd = c((x5, Qd) => {
    ...
    var lp = c((q5, cp) => {
        ...
        function MS(e, t) {
            ...
            if (r instanceof NS) {
                var n = r.__data__;
                if (!PS || n.length < FS - 1) return n.push([e, t]), (this.size = ++r.size), this;
    ...
    var nv = c((iH, rv) => {
        var nR = Tt(),
            ...
            ge = {};
        ge[bR] = ge[TR] = ge[IR] = ge[OR] = ge[wR] = ge[AR] = ge[xR] = ge[SR] = ge[CR] = !0;
        ge[aR] = ge[sR] = ge[ER] = ge[uR] = ge[_R] = ge[cR] = ge[lR] = ge[fR] = ge[dR] = ge[pR] = ge[vR] = ge[gR] = ge[hR] = ge[yR] = ge[mR] = !1;
        function RR(e) {
    ...
    var Bn = c((EH, Mv) => {
        var aa = Ov(),
            ...
            qL = tr(la),
            qt = Fv;
        ((aa && qt(new aa(new ArrayBuffer(1))) != qv) || (sa && qt(new sa()) != Rv) || (ua && qt(ua.resolve()) != Lv) || (ca && qt(new ca()) != Nv) || (la && qt(new la()) != Pv)) &&
        (qt = function (e) {
            var t = Fv(e),
    ...
    var Hv = c((_H, Wv) => {
        ...
        function UL(e, t, r, n, i, o) {
            ...
            if (v && !y) return o || (o = new fa()), a || kL(e) ? FL(e, t, r, n, i, o) : ML(e, t, u, r, n, i, o);
            if (!(r & GL)) {
    ...
    var da = c((bH, zv) => {
        ...
        function jv(e, t, r, n, i) {
            return e === t ? !0 : e == null || t == null || (!Xv(e) && !Xv(t)) ? e !== e && t !== t : BL(e, t, r, n, jv, i);
        }
        zv.exports = jv;
    });
    var Yv = c((TH, Kv) => {
    ...
    var xg = c((VH, Ag) => {
        ...
        function KN(e, t, r) {
            ...
            return o || ++n != i ? o : ((i = e == null ? 0 : e.length), !!i && jN(i) && XN(a, i) && (HN(e) || WN(e)));
        }
        Ag.exports = KN;
    });
    var Cg = c((UH, Sg) => {
    ...
    var nh = {};
    De(nh, { ELEMENT_MATCHES: () => JP, FLEX_PREFIXED: () => Ta, IS_BROWSER_ENV: () => Je, TRANSFORM_PREFIXED: () => wt, TRANSFORM_STYLE_PREFIXED: () => $n, withBrowser: () => Yn });
    var rh,
        Je,
        Yn,
        JP,
        ...
        Qn = he(() => {
            ...
            (rh = le(ba())),
                (Je = typeof window < "u"),
                (Yn = (e, t) => (Je ? e() : t)),
                (JP = Yn(() => (0, rh.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], (e) => e in Element.prototype))),
                (Ta = Yn(() => {
    ...
    var Ia = c((nX, uh) => {
        ...
        function oq(e, t, r, n, i) {
            var o,
                a,
                s = 0;
            do (a = t + (r - t) / 2), (o = Jn(a, n, i) - e), o > 0 ? (r = a) : (t = a);
        ...
        uh.exports = function (t, r, n, i) {
            ...
            if (t !== r || n !== i) for (var a = 0; a < Ur; ++a) o[a] = Jn(a * Zn, t, n);
            function s(u) {
    ...
    var Br,
        ...
        Oa = he(() => {
            "use strict";
            (Br = le(Ia())), (vt = 1.70158), (sq = (0, Br.default)(0.25, 0.1, 0.25, 1)), (uq = (0, Br.default)(0.42, 0, 1, 1)), (cq = (0, Br.default)(0, 0, 0.58, 1)), (lq = (0, Br.default)(0.42, 0, 0.58, 1));
        });
    var lh = {};
    De(lh, { applyEasing: () => Xq, createBezierEasing: () => Hq, optimizeFloat: () => Hr });
    ...
    var ph = {};
    De(ph, { createElementState: () => dh, ixElements: () => oF, mergeActionState: () => Aa });
    ...
    var nr,
        ...
        vh = he(() => {
            ...
            nr = le(Kt());
            Ge();
            ({ HTML_ELEMENT: oX, PLAIN_OBJECT: jq, ABSTRACT_NODE: aX, CONFIG_X_VALUE: zq, CONFIG_Y_VALUE: Kq, CONFIG_Z_VALUE: Yq, CONFIG_VALUE: $q, CONFIG_X_UNIT: Qq, CONFIG_Y_UNIT: Zq, CONFIG_Z_UNIT: Jq, CONFIG_UNIT: eF } = Ce),
                ({ IX2_SESSION_STOPPED: tF, IX2_INSTANCE_ADDED: rF, IX2_ELEMENT_STATE_CHANGED: nF } = Ie),
                (fh = {}),
                (iF = "refState"),
                (oF = (e = fh, t = {}) => {
                    switch (t.type) {
                        ...
                        case rF: {
                            let { elementId: r, element: n, origin: i, actionItem: o, refType: a } = t.payload,
                                { actionTypeId: s } = o,
                                u = e;
                            return (0, nr.getIn)(u, [r, n]) !== n && (u = dh(u, n, a, r, o)), Aa(u, r, s, i, o);
                        }
                        case nF: {
    ...
    var yh = c((Ae) => {
        ...
        var hh = Object.freeze({ positionX: 0, positionY: 0, positionZ: 0, rotationX: 0, rotationY: 0, rotationZ: 0, scaleX: 1, scaleY: 1, scaleZ: 1 }),
            _F = (e, t) => {
    ...
    var Eh = c((xe) => {
        ...
        var CF = (e, t) => {
            ...
            if (r.red != null && r.green != null && r.blue != null) return (0, AF.normalizeColor)(i);
        };
        ...
        var NF = (e, t, r) => {
            let n = r.config.target.objectId,
                ...
                g;
            a != null && (g = a + i), s != null && f != null && u != null && y != null && (g = `rgba(${s}, ${u}, ${f}, ${y})`), g != null && document.documentElement.style.setProperty(n, g);
        };
        xe.renderPlugin = NF;
        var PF = (e, t) => {
    ...
    var bh = {};
    De(bh, { clearPlugin: () => Ma, createPluginInstance: () => kF, getPluginConfig: () => Na, getPluginDestination: () => qa, getPluginDuration: () => DF, getPluginOrigin: () => Pa, isPluginType: () => Ft, renderPlugin: () => Fa });
    function Ft(e) {
    ...
    var Gh = c((IX, kh) => {
        ...
        function lM(e, t, r) {
            ...
            if (!n) return -1;
            var i = n - 1;
            return r !== void 0 && ((i = sM(r)), (i = r < 0 ? uM(n + i, 0) : cM(i, n - 1))), oM(e, aM(t, 3), i, !0);
        }
        kh.exports = lM;
    });
    var Uh = c((OX, Vh) => {
    ...
    function gM(e, t) {
        ...
        for (let i = 0; i < r.length; i++) if (!vM.call(t, r[i]) || !Bh(e[r[i]], t[r[i]])) return !1;
        return !0;
    }
    var vM,
        Va,
    ...
    function Xa({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
        ...
        let { targets: o } = e;
        if (Array.isArray(o) && o.length > 0) return o.reduce((k, x) => k.concat(Xa({ config: { target: x }, event: t, eventTarget: r, elementRoot: n, elementApi: i })), []);
        let { getValidDocument: a, getQuerySelector: s, queryDocument: u, getChildElements: f, getSiblingElements: y, matchSelector: g, elementContains: v, isSiblingNode: m } = i,
            { target: w } = e;
        if (!w) return [];
        let { id: I, objectId: C, selector: O, selectorGuids: N, appliesTo: R, useEventTarget: q } = jh(w);
        ...
        let P = (t?.action?.config?.affectedElements ?? {})[I || O] || {},
            ...
            J,
            re = t && s(jh(t.target));
        if ((W ? ((X = P.limitAffectedElements), (K = re), (J = s(P))) : (K = J = s({ id: I, selector: O, selectorGuids: N })), t && q)) {
        ...
        return K == null || J == null ? [] : Je && n ? u(J).filter((k) => n.contains(k)) : X === Hh ? u(K, J) : X === SM ? f(u(K)).filter(g(J)) : X === Xh ? y(u(K)).filter(g(J)) : u(J);
    }
        ...
        switch (n.actionTypeId) {
            ...
            case ur: {
                let s = o(e, ut),
                    ...
                    y;
                return (
                    n.config.widthUnit === At ? (f = zh.test(s) ? parseFloat(s) : parseFloat(r.width)) : (f = (0, gt.default)(parseFloat(s), parseFloat(r.width))),
                        n.config.heightUnit === At ? (y = zh.test(u) ? parseFloat(u) : parseFloat(r.height)) : (y = (0, gt.default)(parseFloat(u), parseFloat(r.height))),
            ...
            case lr:
            case fr:
                return uD({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: o });
            case si:
    ...
    function eD(e, t, r, n, i) {
        let o = JM.map((s) => {
                let u = ja[s],
                    { xValue: f = u.xValue, yValue: y = u.yValue, zValue: g = u.zValue, xUnit: v = "", yUnit: m = "", zUnit: w = "" } = t[s] || {};
                switch (s) {
                    case or:
    ...
    function uD({ element: e, actionTypeId: t, computedStyle: r, getStyle: n }) {
        let i = Ha[t],
            ...
            a = oD.test(o) ? o : r[i],
            s = sD(aD, a).split(zr);
        return { rValue: (0, gt.default)(parseInt(s[0], 10), 255), gValue: (0, gt.default)(parseInt(s[1], 10), 255), bValue: (0, gt.default)(parseInt(s[2], 10), 255), aValue: (0, gt.default)(parseFloat(s[3]), 1) };
    }
    function cD(e, t, r, n, i, o) {
        ...
        switch (n.actionTypeId) {
            case ur: {
                ...
                f !== void 0 && (s === At && (s = "px"), Dt(e, ut, o), a(e, ut, f + s)), y !== void 0 && (u === At && (u = "px"), Dt(e, ct, o), a(e, ct, y + u));
                break;
            }
            case Yr: {
                tD(e, r, n.config, o);
            ...
            case fr: {
                let s = Ha[n.actionTypeId],
                    ...
                    g = r.aValue;
                Dt(e, s, o), a(e, s, g >= 1 ? `rgb(${u},${f},${y})` : `rgba(${u},${f},${y},${g})`);
                break;
            }
            default: {
                let { unit: s = "" } = n.config;
    ...
    function Yh({ actionGroup: e, event: t, elementApi: r }) {
        ...
        n.forEach((i) => {
            let { actionTypeId: o, config: a } = i,
                s;
            Ft(o) ? (s = (u) => Ma(o)(u, i)) : (s = oy({ effect: pD, actionTypeId: o, elementApi: r })), Xa({ config: a, event: t, elementApi: r }).forEach(s);
        });
    }
    function dD(e, t, r) {
    ...
    function gD({ actionList: e, actionItemId: t, rawData: r }) {
        let { actionItemGroups: n, continuousParameterGroups: i } = e,
            o = [],
            a = (s) => (o.push((0, ai.mergeIn)(s, ["config"], { delay: 0, duration: 0 })), s.id === t);
        return (
            ...
            i.some((s) => {
                ...
                (0, ai.setIn)(r, ["actionLists"], { [e.id]: { id: e.id, actionItemGroups: [{ actionItems: o }] } })
        );
    }
    ...
    var gt,
        ...
        uy = he(() => {
            ...
            ({
                ...
                (ry = Object.freeze({ [wt]: yM, [Qh]: hM, [ni]: ni, [Xr]: Xr, [ut]: ut, [ct]: ct, [jr]: jr })),
                (ti = new Map());
            PM = 1;
            FM = 1;
            kM = (e, t) => e === t;
            (zh = /px/),
                (UM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = $M[n.type]), r), e || {})),
                (BM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = QM[n.type] || n.defaultValue || 0), r), e || {}));
            (HM = (e, t) => (t && (e[t.type] = t.value || 0), e)),
                ...
                (jM = (e, t, r) => {
                    ...
                    switch (e) {
                        ...
                        case $r: {
                            let n = (0, ri.default)(r.fontVariations, ({ type: i }) => i === t);
                            return n ? n.value : 0;
                        }
                        default:
                            return r[t];
            ...
            (ja = {
                ...
                ($M = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 })),
    ...
    var ci,
        ...
        fy = he(() => {
            ...
            (ci = le(kt())),
                (ht = le(Kt())),
                ({ IX2_RAW_DATA_IMPORTED: xD, IX2_SESSION_STOPPED: SD, IX2_INSTANCE_ADDED: CD, IX2_INSTANCE_STARTED: RD, IX2_INSTANCE_REMOVED: LD, IX2_ANIMATION_FRAME_CHANGED: ND } = Ie),
                ({ optimizeFloat: ui, applyEasing: cy, createBezierEasing: PD } = ci.IX2EasingUtils),
                ({ RENDER_GENERAL: qD } = Ce),
                ({ getItemConfigByKey: za, getRenderType: FD, getStyleProp: MD } = ci.IX2VanillaUtils),
                (DD = (e, t) => {
                    let { position: r, parameterId: n, actionGroups: i, destinationKeys: o, smoothing: a, restingValue: s, actionTypeId: u, customEasingFn: f, skipMotion: y, skipToValue: g } = e,
                    ...
                    for (let X = 0, { length: K } = i; X < K; X++) {
                        ...
                        if ((X === 0 && (R = re[0]), N >= J)) {
                            ...
                            let k = i[X + 1],
                                x = k && N !== J;
                            (q = x ? k.actionItems[0] : null), x && ((F = J / 100), (P = (k.keyframe - J) / 100));
                        }
                    }
                    let W = {};
                    if (R && !q)
                ...
                (kD = (e, t) => {
                    let { active: r, origin: n, start: i, immediate: o, renderType: a, verbose: s, actionItem: u, destination: f, destinationKeys: y, pluginDuration: g, instanceDelay: v, customEasingFn: m, skipMotion: w } = e,
                        I = u.config.easing,
                        { duration: C, delay: O } = u.config;
                    g != null && (C = g), (O = v ?? O), a === qD ? (C = 0) : (o || w) && (C = O = 0);
                    let { now: N } = t.payload;
                    if (r && n) {
                        let R = N - (i + O);
                        if (s) {
                    ...
                    switch (t.type) {
                        ...
                        case CD: {
                            let {
                                ...
                                J = FD(K),
                                re = MD(J, K),
                                k = Object.keys(v).filter((M) => v[M] != null && typeof v[M] != "string"),
                                { easing: x } = i.config;
                            return (0, ht.set)(e, r, {
                                id: r,
                                elementId: n,
    ...
    var GD,
        ...
        py = he(() => {
            "use strict";
            Ge();
            ({ IX2_RAW_DATA_IMPORTED: GD, IX2_SESSION_STOPPED: VD, IX2_PARAMETER_CHANGED: UD } = Ie),
                (dy = (e = {}, t) => {
                    switch (t.type) {
                        case GD:
    ...
    var vy,
        ...
        yy = he(() => {
            ...
            fy();
            py();
            ({ ixElements: BD } = gy.IX2ElementsReducer), (WD = (0, vy.combineReducers)({ ixData: xf, ixRequest: Kf, ixSession: Qf, ixElements: BD, ixInstances: ly, ixParameters: dy }));
        });
    var Ey = c((UX, my) => {
        var HD = Tt(),
            XD = Oe(),
    ...
    var Wy = c(($X, By) => {
        ...
        function G1(e, t, r) {
            var n = e[t];
            (!(k1.call(e, t) && M1(n, r)) || (r === void 0 && !(t in e))) && F1(e, t, r);
        }
        By.exports = G1;
    });
    var jy = c((QX, Xy) => {
        ...
        function H1(e, t, r, n) {
            ...
            for (var i = -1, o = t.length, a = o - 1, s = e; s != null && ++i < o; ) {
                ...
                if (i != a) {
                    var y = s[u];
                    (f = n ? n(y, u, s) : void 0), f === void 0 && (f = Hy(y) ? y : B1(t[i + 1]) ? [] : {});
                }
                V1(s, u, f), (s = s[u]);
            }
            return e;
    ...
    var lm = c((aj, cm) => {
        ...
        function D2(e) {
            if (e == null) return !0;
            if (C2(e) && (S2(e) || typeof e == "string" || typeof e.splice == "function" || R2(e) || N2(e) || x2(e))) return !e.length;
            var t = A2(e);
    ...
    var Im = c((dj, Tm) => {
        ...
        function rk(e, t, r) {
            ...
            (t = bm(t) || 0), Z2(r) && ((y = !!r.leading), (g = "maxWait" in r), (o = g ? ek(bm(r.maxWait) || 0, t) : o), (v = "trailing" in r ? !!r.trailing : v));
            function m(P) {
                var W = n,
                    X = i;
    ...
    var wm = c((pj, Om) => {
        ...
        function ak(e, t, r) {
            ...
            return ik(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)), nk(e, t, { leading: n, maxWait: t, trailing: i });
        }
        Om.exports = ak;
    });
    var xm = {};
    ...
    var Am,
        ...
        pi = he(() => {
            ...
            (Am = le(kt())),
                ...
                (es = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: uk, payload: { hasBoundaryNodes: e, reducedMotion: t } })),
                (ts = () => ({ type: ck })),
                (rs = () => ({ type: lk })),
                (Sk = ({ rawData: e, defer: t }) => ({ type: fk, payload: { defer: t, rawData: e } })),
                (Ck = ({ actionTypeId: e = ke.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: a, verbose: s, rawData: u }) => ({
                    type: dk,
                ...
                (Lk = () => ({ type: vk })),
                (li = (e, t) => ({ type: gk, payload: { target: e, listenerParams: t } })),
                ...
                (as = (e, t, r, n) => ({ type: Ik, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } })),
                (vr = ({ actionListId: e, isPlaying: t }) => ({ type: Ok, payload: { actionListId: e, isPlaying: t } })),
                (ss = ({ width: e, mediaQueries: t }) => ({ type: wk, payload: { width: e, mediaQueries: t } })),
                (us = () => ({ type: Ak }));
        });
    var qe = {};
    De(qe, {
    ...
    function ls({ id: e, selector: t }) {
        if (e) {
            ...
            if (e.indexOf(Sm) !== -1) {
                let n = e.split(Sm),
                    i = n[0];
                if (((r = n[1]), i !== document.documentElement.getAttribute(Rm))) return null;
            }
    ...
    function Gk(e) {
        return e == null || e === document.documentElement.getAttribute(Rm) ? document : null;
    }
    function Vk(e, t) {
    ...
    function ds(e) {
        return e != null && typeof e == "object" ? (e instanceof Element ? Pk : qk) : null;
    }
    var Cm,
        cs,
        Sm,
        ...
        Lm = he(() => {
            ...
            Cm = le(kt());
            Ge();
            ({ ELEMENT_MATCHES: cs } = Cm.IX2BrowserSupport), ({ IX2_ID_DELIMITER: Sm, HTML_ELEMENT: Pk, PLAIN_OBJECT: qk, WF_PAGE: Rm } = Ce);
    ...
    var Bm = c((_j, Um) => {
        ...
        function Vm(e, t, r, n, i) {
            ...
            for (r || (r = Jk), i || (i = []); ++o < a; ) {
                var s = e[o];
                t > 0 && r(s) ? (t > 1 ? Vm(s, t - 1, r, n, i) : Zk(i, s)) : n || (i[i.length] = s);
            }
            return i;
        }
        Um.exports = Vm;
        ...
        function iG(e, t, r) {
            return (
                (t = zm(t === void 0 ? e.length - 1 : t, 0)),
                    function () {
                        for (var n = arguments, i = -1, o = zm(n.length - t, 0), a = Array(o); ++i < o; ) a[i] = n[t + i];
                        i = -1;
    ...
    var eE = c((wj, Jm) => {
        var aG = Qm(),
            ...
            uG = Zm
                ? function (e, t) {
                    return Zm(e, "toString", { configurable: !0, enumerable: !1, value: aG(t), writable: !0 });
                }
                : sG;
        Jm.exports = uG;
    });
    ...
    var gs = c((Pj, yE) => {
        ...
        function xG(e) {
            for (var t = e.name + "", r = hE[t], n = AG.call(hE, t) ? r.length : 0; n--; ) {
                var i = r[n],
                    o = i.func;
    ...
    var mi = c((qj, mE) => {
        var SG = ps(),
            ...
            RG = 4294967295;
        function yi(e) {
            (this.__wrapped__ = e), (this.__actions__ = []), (this.__dir__ = 1), (this.__filtered__ = !1), (this.__iteratees__ = []), (this.__takeCount__ = RG), (this.__views__ = []);
        }
        ...
        function rV(e) {
            return KG(function (t) {
                ...
                for (n = a ? n : r; ++n < r; ) {
                    ...
                    u && CE(u[0]) && u[1] == (eV | ZG | JG | tV) && !u[4].length && u[9] == 1 ? (a = a[hs(u[0])].apply(a, u[3])) : (a = o.length == 1 && CE(o) ? a[s]() : a.thru(o));
                }
                return function () {
                    var f = arguments,
                        y = f[0];
                    if (a && f.length == 1 && $G(y)) return a.plant(y).value();
                    for (var g = 0, v = r ? t[g].apply(this, f) : y; ++g < r; ) v = t[g].call(this, v);
                    return v;
                };
            });
        }
    ...
    var DE = c((Bj, ME) => {
        var aV = FE(),
            ys = Kn();
        function sV(e, t, r) {
            return r === void 0 && ((r = t), (t = void 0)), r !== void 0 && ((r = ys(r)), (r = r === r ? r : 0)), t !== void 0 && ((t = ys(t)), (t = t === t ? t : 0)), aV(ys(e), t, r);
        }
        ME.exports = sV;
    });
    var jE,
            ...
            (YE = le(kt())),
                ...
                (Ue = ({ store: e, event: t, element: r, eventStateKey: n }, i) => {
                    let { action: o, id: a } = t,
                        ...
                        f = r_(e, u);
                    return (
                        f && gr({ store: e, eventId: u, eventTarget: r, eventStateKey: u + kE + n.split(kE)[1], actionListId: (0, zE.default)(f, "action.config.actionListId") }),
                            gr({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: s }),
                            tn({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: s }),
                            i
                    );
                }),
                ...
                (NV = (e, t) => !(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top)),
                ...
                (qV = (e) => {
                    ...
                    return NV(t.getBoundingClientRect(), { left: 0, top: u, right: n, bottom: i - u });
                }),
                (i_ = (e) => (t, r) => {
                ...
                (BE = (e) => (t, r = {}) => {
                    ...
                    let m = (y ? u : (o * (u || 0)) / 100) / g,
                        ...
                        I,
                        C = 0;
                    r && ((w = v > r.percentTop), (I = r.scrollingDown !== w), (C = I ? v : r.anchorTop));
                    let O = s === $E ? v >= C + m : v <= C - m,
                        N = { ...r, percentTop: v, inBounds: O, anchorTop: C, scrollingDown: w };
                ...
                (HE = {
                    ...
                    handler: FV((e, t) => {
                        let { elementVisible: r } = t,
                            ...
                            { ixData: o } = i.getState(),
                            { events: a } = o;
                        return !a[n.action.config.autoStopEventId] && t.triggered ? t : (n.eventTypeId === QE) === r ? (Ue(e), { ...t, triggered: !0 }) : t;
                    }),
                }),
                (XE = 0.05),
                (o_ = {
                    ...
                    [TV]: {
                        ...
                        handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
                            let { basedOn: a, selectedAxis: s, continuousParameterGroupId: u, reverse: f, restingState: y = 0 } = r,
                                { clientX: g = o.clientX, clientY: v = o.clientY, pageX: m = o.pageX, pageY: w = o.pageY } = n,
                                I = s === "X_AXIS",
                                C = n.type === "mouseout",
                                O = y / 100,
                                N = u,
                            ...
                            switch (a) {
                                case at.VIEWPORT: {
                                    O = I ? Math.min(g, window.innerWidth) / window.innerWidth : Math.min(v, window.innerHeight) / window.innerHeight;
                                    break;
                                }
                                case at.PAGE: {
                                    let { scrollLeft: q, scrollTop: F, scrollWidth: P, scrollHeight: W } = Zr();
                            ...
                            return (
                                ...
                                (a !== at.ELEMENT || R || R !== o.elementHovered) && ((O = f ? 1 - O : O), e.dispatch(pr(N, O))),
                                    { elementHovered: R, clientX: g, clientY: v, pageX: m, pageY: w }
                            );
                        },
                    },
                    [SV]: {
                    ...
                    [wV]: {
                        ...
                        handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
                            let { scrollLeft: o, scrollTop: a, scrollWidth: s, scrollHeight: u, clientHeight: f } = Zr(),
                                { basedOn: y, selectedAxis: g, continuousParameterGroupId: v, startsEntering: m, startsExiting: w, addEndOffset: I, addStartOffset: C, addOffsetValue: O = 0, endOffsetValue: N = 0 } = r,
                                R = g === "X_AXIS";
                            if (y === at.VIEWPORT) {
                                let q = R ? o / s : a / u;
                                return q !== i.scrollPercent && t.dispatch(pr(v, q)), { scrollPercent: q };
                            } else {
                                let q = GE(n, v),
                                ...
                                return x !== i.scrollPercent && t.dispatch(pr(q, x)), { scrollPercent: x };
                            }
                        },
                    },
                    [QE]: HE,
                    ...
                    [ZE]: { types: "readystatechange IX2_PAGE_UPDATE", handler: et(Jr, DV(Ue)) },
                    [JE]: { types: "readystatechange IX2_PAGE_UPDATE", handler: et(Jr, kV(Ue)) },
                });
        });
    var I_ = {};
    De(I_, { observeRequests: () => iU, startActionGroup: () => tn, startEngine: () => xi, stopActionGroup: () => gr, stopAllActionGroups: () => __, stopEngine: () => Si });
    function iU(e) {
    ...
    function oU(e) {
        Gt({
            ...
            onChange: () => {
                Si(e), h_({ store: e, elementApi: qe }), xi({ store: e, allowEvents: !0 }), y_();
            },
        });
    }
    function aU(e, t) {
    ...
    function uU(e, t) {
        ...
        if ((xi({ store: t, rawData: y, allowEvents: a, testManual: u }), (n && r === ke.GENERAL_START_ACTION) || Ts(r))) {
            gr({ store: t, actionListId: n }), E_({ store: t, actionListId: n, eventId: o });
            let g = tn({ store: t, eventId: o, actionListId: n, immediate: s, verbose: f });
    ...
    function xi({ store: e, rawData: t, allowEvents: r, testManual: n }) {
        ...
        t && e.dispatch(Ja(t)),
        i.active ||
        (e.dispatch(es({ hasBoundaryNodes: !!document.querySelector(Ii), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })),
        r && (hU(e), fU(), e.getState().ixSession.hasDefinedMediaQueries && oU(e)),
            e.dispatch(ts()),
            dU(e, n));
    }
    function fU() {
    ...
    function dU(e, t) {
        let r = (n) => {
            ...
            i.active && (e.dispatch(fi(n, o)), t ? aU(e, r) : requestAnimationFrame(r));
        };
    ...
    function vU({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: a, smoothing: s, restingValue: u }) {
        ...
        O.forEach((q) => {
            ...
            P.forEach((W) => {
                ...
                if (((I[re] = gU(I[re], F, W)), !w[re])) {
                    w[re] = !0;
                    let { config: k } = W;
                    Oi({ config: k, event: v, eventTarget: r, elementRoot: J, elementApi: qe }).forEach((x) => {
            ...
            C.forEach(({ element: q, key: F }) => {
                ...
                As({ store: e, element: q, eventId: n, actionListId: o, actionItem: W, destination: J, continuous: !0, parameterId: N, actionGroups: P, smoothing: s, restingValue: u, pluginInstance: K });
            });
    }
    function gU(e = [], t, r) {
        let n = [...e],
    ...
    function TU({ logic: e, store: t, events: r }) {
        ...
        (0, hr.default)(s, (g, v) => {
            ...
            (Array.isArray(m.config) ? m.config : [m.config]).forEach((R) => {
                ...
                g.forEach((K, J) => {
                    let re = I + Is + J;
                    vU({ store: t, eventStateKey: re, eventTarget: K, eventId: I, eventConfig: R, actionListId: O, parameterGroup: P, smoothing: W, restingValue: X });
                });
            }),
            (w.actionTypeId === ke.GENERAL_START_ACTION || Ts(w.actionTypeId)) && E_({ store: t, actionListId: O, eventId: I });
        });
        let u = (g) => {
                ...
                _U(s, (m, w, I) => {
                    ...
                    let q = (F = {}) => {
                        let P = i({ store: t, element: m, event: C, eventConfig: F, nativeEvent: g, eventStateKey: I }, O);
                        eU(P, O) || t.dispatch(ns(I, P));
                    };
                    N.actionTypeId === ke.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(C.config) ? C.config : [C.config]).forEach(q) : q();
                });
            },
            f = (0, v_.default)(u, nU),
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            f.forEach((g) => {
                let { config: v, actionTypeId: m } = g,
                    w = v?.target?.useEventTarget === !0 && v?.target?.objectId == null ? { target: s.target, targets: s.targets } : v,
                    I = Oi({ config: w, event: s, elementApi: qe }),
                    C = Ai(m);
                I.forEach((O) => {
                    let N = C ? ws(m)(O, g) : null;
                    As({ destination: Os({ element: O, actionItem: g, elementApi: qe }, N), immediate: !0, store: e, element: O, eventId: r, actionItem: g, actionListId: t, pluginInstance: N });
                });
            });
        }
    }
    ...
    function gr({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i }) {
        ...
        (0, hr.default)(o, (u) => {
            ...
            if (u.actionListId === i && u.eventId === t && y) {
                ...
                xs(u, e), u.verbose && e.dispatch(vr({ actionListId: i, isPlaying: !1 }));
            }
        });
    }
    function tn({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o = 0, immediate: a, verbose: s }) {
        ...
        o >= w.length && (0, yt.default)(g, "config.loop") && (o = 0), o === 0 && I && o++;
        let O = (o === 0 || (o === 1 && I)) && Ts(g.action?.actionTypeId) ? g.config.delay : void 0,
        ...
        return (
            N.forEach((P, W) => {
                ...
                Oi({ config: X, event: g, eventTarget: r, elementRoot: k, elementApi: qe }).forEach((M, H) => {
    ...
    function As(e) {
        let { store: t, computedStyle: r, ...n } = e,
            { element: i, actionItem: o, immediate: a, pluginInstance: s, continuous: u, restingValue: f, eventId: y } = n,
            g = !u,
            v = BV(),
        ...
        if ((t.dispatch(is({ instanceId: v, elementId: C, origin: F, refType: N, skipMotion: R, skipToValue: q, ...n })), b_(document.body, "ix2-animation-started", v), a)) {
            OU(t, v);
            return;
        }
        Gt({ store: t, select: ({ ixInstances: P }) => P[v], onChange: T_ }), g && t.dispatch(di(v, w.tick));
    }
    function xs(e, t) {
    ...
    function T_(e, t) {
        ...
        if (wi(W, q.mediaQueryKey) && (n || r || i)) {
            ...
            if (i) {
                if (I) {
                    let X = tn({ store: t, eventId: g, eventTarget: v, eventStateKey: m, actionListId: w, groupIndex: y + 1, verbose: O });
    ...
    var c_,
        ...
        bs = he(() => {
            "use strict";
            (c_ = le(ba())), (yt = le(jn())), (l_ = le(My())), (f_ = le(um())), (d_ = le(lm())), (p_ = le(dm())), (hr = le(mm())), (v_ = le(wm()));
            Ge();
            Ti = le(kt());
            pi();
            Lm();
            ...
            (GV = Object.keys(On)),
                (Ts = (e) => GV.includes(e)),
                ({ COLON_DELIMITER: Is, BOUNDARY_SELECTOR: Ii, HTML_ELEMENT: g_, RENDER_GENERAL: VV, W_MOD_IX: s_ } = Ce),
                ({
                ...
                ({ isPluginType: Ai, createPluginInstance: ws, getPluginDuration: tU } = Ti.IX2VanillaPlugins),
    ...
    var L_ = c((Zj, R_) => {
        ...
        yr.define(
            ...
            (R_.exports = function (e, t) {
                ...
                function m() {
                    (i = o && yr.env("design")), (v = yr.env("slug") || a.pathname || ""), yr.scroll.off(I), (g = []);
                    for (var O = document.links, N = 0; N < O.length; ++N) w(O[N]);
                    g.length && (yr.scroll.on(I), I());
                }
                function w(O) {
                    if (!O.getAttribute("hreflang")) {
                        var N = (i && O.getAttribute("href-disabled")) || O.getAttribute("href");
                        if (((s.href = N), !(N.indexOf(":") >= 0))) {
                            ...
                            if (!(N === "#" || N === "")) {
                                var F = s.href === a.href || N === v || (f.test(N) && y.test(v));
                                C(R, u, F);
                            }
                        }
                    }
        ...
        Ci.define(
            ...
            (N_.exports = function (e) {
                ...
                function q(k) {
                    ...
                    if (!(Ci.env("design") || (window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(x.className)))) {
                        var M = C(x) ? x.hash : "";
                        if (M !== "") {
                            var H = e(M);
                            H.length &&
                            (k && (k.preventDefault(), k.stopPropagation()),
                                ...
                                window.setTimeout(
                                    function () {
                                        P(H, function () {
                                            R(H, "add"), H.get(0).focus({ preventScroll: !0 }), R(H, "remove");
                                        });
                                    },
                                    k ? 0 : 300
                                ));
                ...
                function F(k) {
                    if (r.hash !== k && n && n.pushState && !(Ci.env.chrome && r.protocol === "file:")) {
                ...
                function P(k, x) {
                    ...
                    if (M !== H) {
                        var B = X(k, M, H),
                            ...
                            ne = function () {
                                var D = Date.now() - ee;
                                window.scroll(0, K(M, H, D, B)), D <= B ? s(ne) : typeof x == "function" && x();
                            };
                        s(ne);
                    }
                }
        ...
        NU.define(
            ...
            (q_.exports = function (e) {
                ...
                function n(o) {
                    ...
                    function g(C) {
                        var O = C.touches;
                        (O && O.length > 1) || ((a = !0), O ? ((s = !0), (f = O[0].clientX)) : (f = C.clientX), (y = f));
                    }
                    function v(C) {
                        if (a) {
                            ...
                            var O = C.touches,
                                ...
                                R = N - y;
                            (y = N), Math.abs(R) > u && r && String(r()) === "" && (i("swipe", C, { direction: R > 0 ? "right" : "left" }), w());
                        }
                    }
                    function m(C) {
    ...
    var M_ = c((Rs) => {
        ...
        function PU(e, t, r, n, i, o, a, s, u, f, y, g, v) {
            return function (m) {
                ...
                g.ajax({ url: v, type: "POST", data: I, dataType: "json", crossDomain: !0 })
                    .done(function (N) {
        ...
        Ri.define(
            ...
            (D_.exports = function (e, t) {
                ...
                function R(D, z) {
                    ...
                    if (((E.handler = null), (E.redirect = d.attr("data-redirect")), C.test(j))) {
                        E.handler = x;
                        return;
                    }
                    if (!j) {
                ...
                function q() {
                    ...
                    n.on("change", s + ' form input[type="checkbox"]:not(' + D + ")", ($) => {
                        e($.target).siblings(D).toggleClass(d);
                    }),
                        n.on("change", s + ' form input[type="radio"]', ($) => {
                            e(`input[name="${$.target.name}"]:not(${D})`).map((ue, _e) => e(_e).siblings(z).removeClass(d));
                            let Q = e($.target);
                            Q.hasClass("w-radio-input") || Q.siblings(z).addClass(d);
                        }),
                        j.forEach(([$, Q]) => {
                            n.on("focus", s + ` form input[type="${$}"]:not(` + Q + ")", (ue) => {
                                e(ue.target).siblings(Q).addClass(E), e(ue.target).filter(h).siblings(Q).addClass(b);
                            }),
                ...
                function F(D) {
                    ...
                    (D.wait = D.btn.attr("data-wait") || null), (D.success = !1), z.prop("disabled", !1), D.label && z.val(D.label);
                }
                function P(D) {
                    var z = D.btn,
                        d = D.wait;
                ...
                function W(D, z) {
                    ...
                    return (
                        (z = z || {}),
                            D.find(':input:not([type="submit"]):not([type="file"])').each(function (E, b) {
                                var h = e(b),
                                    j = h.attr("type"),
                                ...
                                if (j === "checkbox") Q = h.is(":checked");
                                    ...
                                    Q = D.find('input[name="' + h.attr("name") + '"]:checked').val() || null;
                                }
                                typeof Q == "string" && (Q = e.trim(Q)), (z[$] = Q), (d = d || re(h, j, $, Q));
                            }),
                            d
                    );
                }
                ...
                function re(D, z, d, E) {
                    ...
                    return (
                        z === "password"
                            ...
                            : D.attr("required")
                                ? E
                                    ? f.test(D.attr("type")) && (y.test(E) || (b = "Please enter a valid email address for: " + d))
                                    : (b = "Please fill out the required field: " + d)
                                : d === "g-recaptcha-response" && !E && (b = "Please confirm you\u2019re not a robot."),
                            b
                    );
                }
                function k(D) {
                ...
                function x(D) {
                    ...
                    ($ = h.substring($, h.indexOf("&", $))),
                        ...
                        e
                            ...
                            .done(function (Q) {
                                (D.success = Q.result === "success" || /already/.test(Q.msg)), D.success || console.info("MailChimp error: " + Q.msg), M(D);
                            })
                            .fail(function () {
                                M(D);
                            });
                ...
                function M(D) {
                    ...
                    D.done.toggle(E), D.fail.toggle(!E), E ? D.done.focus() : D.fail.focus(), z.toggle(!E), F(D);
                }
                function H(D) {
                ...
                function B(D, z) {
                    ...
                    if (
                        ...
                        ue.on("click keydown", function (T) {
                            (T.type === "keydown" && T.which !== 13 && T.which !== 32) || (T.preventDefault(), Q.click());
                        }),
                        ...
                        G.on("click keydown", function (T) {
                            ...
                            Q.on("change", function (T) {
                                (d = T.target && T.target.files && T.target.files[0]), d && (b.toggle(!1), $.toggle(!1), h.toggle(!0), h.focus(), Y.text(d.name), S() || P(z), (z.fileUploads[D].uploading = !0), ee(d, _));
                            });
                    ...
                    function l(T) {
                        var L = T.responseJSON && T.responseJSON.msg,
                            Z = Fe;
                        typeof L == "string" && L.indexOf("InvalidFileTypeError") === 0 ? (Z = fe) : typeof L == "string" && L.indexOf("MaxFileSizeError") === 0 && (Z = V),
                            oe.text(Z),
                    ...
                    function A(T) {
                        if (T) return l(T);
                        h.toggle(!1), j.css("display", "inline-block"), j.focus(), (z.fileUploads[D].uploading = !1), S() || F(z);
                    }
                    function S() {
                ...
                function ne(D, z, d, E, b) {
                    ...
                    h.append("file", d, E),
                        e
                            .ajax({ type: "POST", url: D, data: h, processData: !1, contentType: !1 })
                            .done(function () {
                                b(null);
                            })
                            .fail(function ($) {
    ...
    var V_ = c((nz, G_) => {
        ...
        xt.define(
            ...
            (G_.exports = function (e, t) {
                ...
                function F() {
                    (f = g && xt.env("design")), (y = xt.env("editor")), (s = e(document.body)), (u = o.find(m)), u.length && (u.each(K), P(), W());
                }
                function P() {
                    xt.resize.off(X);
                }
                ...
                function K(p, G) {
                    var Y = e(G),
                        V = e.data(G, m);
                    V || (V = e.data(G, m, { open: !1, el: Y, config: {}, selectedIdx: -1 })),
                    ...
                    V.button.attr("aria-label") == null && V.button.attr("aria-label", "menu"),
                        ...
                        V.menu.off(m),
                        x(V),
                        f ? (re(V), V.el.on("setting" + m, M(V))) : (k(V), V.button.on("click" + m, D(V)), V.menu.on("click" + m, "a", z(V)), V.button.on("keydown" + m, H(V)), V.el.on("keydown" + m, B(V))),
                        b(p, G);
                }
                function J(p, G) {
                    var Y = e.data(G, m);
                ...
                function k(p) {
                    p.overlay || ((p.overlay = e(v).appendTo(p.el)), p.overlay.attr("id", p.overlayContainerId), (p.parent = p.menu.parent()), oe(p, !0));
                }
                function x(p) {
                    var G = {},
                        Y = p.config || {},
                ...
                function H(p) {
                    return function (G) {
                        switch (G.keyCode) {
                            ...
                            case Se.HOME:
                            case Se.END:
                                return p.open ? (G.keyCode === Se.END ? (p.selectedIdx = p.links.length - 1) : (p.selectedIdx = 0), ee(p), G.preventDefault(), G.stopPropagation()) : (G.preventDefault(), G.stopPropagation());
                        }
                    };
                }
                function B(p) {
                    return function (G) {
                        if (p.open)
                            switch (((p.selectedIdx = p.links.index(document.activeElement)), G.keyCode)) {
                                case Se.HOME:
                                case Se.END:
                                    return G.keyCode === Se.END ? (p.selectedIdx = p.links.length - 1) : (p.selectedIdx = 0), ee(p), G.preventDefault(), G.stopPropagation();
                                case Se.ESCAPE:
                                    return oe(p), p.button.focus(), G.preventDefault(), G.stopPropagation();
                                case Se.ARROW_LEFT:
                                case Se.ARROW_UP:
                                    return (p.selectedIdx = Math.max(-1, p.selectedIdx - 1)), ee(p), G.preventDefault(), G.stopPropagation();
                                case Se.ARROW_RIGHT:
                                case Se.ARROW_DOWN:
                                    return (p.selectedIdx = Math.min(p.links.length - 1, p.selectedIdx + 1)), ee(p), G.preventDefault(), G.stopPropagation();
                            }
                    };
                }
                function ee(p) {
                ...
                function ue(p, G) {
                    if (p.open) return;
                    (p.open = !0), p.menu.each($), p.links.addClass(N), p.dropdowns.addClass(I), p.dropdownToggle.addClass(C), p.dropdownList.addClass(O), p.button.addClass(w);
                    var Y = p.config,
                        V = Y.animation;
                    ...
                    var fe = _e(p),
                        ...
                        l = p.el.height(),
                        _ = p.el[0];
                    if ((b(0, _), R.intro(0, _), xt.redraw.up(), f || o.on("click" + m, p.outside), G)) {
                        T();
                        return;
                    }
                    var A = "transform " + Y.duration + "ms " + Y.easing;
                    if ((p.overlay && ((q = p.menu.prev()), p.overlay.show().append(p.menu)), Y.animOver)) {
                        n(p.menu)
                            .add(A)
                ...
                function _e(p) {
                    ...
                    return G.animOver ? p.menu.height(Y) : p.el.css("position") !== "fixed" && (Y -= p.el.outerHeight(!0)), p.overlay && p.overlay.height(Y), Y;
                }
                function oe(p, G) {
                    if (!p.open) return;
                    (p.open = !1), p.button.removeClass(w);
                    var Y = p.config;
                    if (((Y.animation === "none" || !n.support.transform || Y.duration <= 0) && (G = !0), R.outro(0, p.el[0]), o.off("click" + m, p.outside), G)) {
                        n(p.menu).stop(), _();
                        return;
                    }
                    ...
                    function _() {
                        ...
                        p.overlay && p.overlay.children().length && (q.length ? p.menu.insertAfter(q) : p.menu.prependTo(p.parent), p.overlay.attr("style", "").hide()),
    ...
    var W_ = c((iz, B_) => {
        ...
        var St = Be(),
            FU = ln(),
            ft = { ARROW_LEFT: 37, ARROW_UP: 38, ARROW_RIGHT: 39, ARROW_DOWN: 40, SPACE: 32, ENTER: 13, HOME: 36, END: 35 },
        ...
        St.define(
            ...
            (B_.exports = function (e, t) {
                ...
                function R(d, E) {
                    var b = e(E),
                        h = e.data(E, u);
                    h || (h = e.data(E, u, { index: 0, depth: 1, hasFocus: { keyboard: !1, mouse: !1 }, el: b, config: {} })),
                    ...
                    h.el.off(u),
                        ...
                        a
                            ...
                            h.config.autoplay && !h.hasTimer && ((h.hasTimer = !0), (h.timerCount = 1), re(h)),
                ...
                function q(d) {
                    ...
                    if (
                        ...
                        F(d.el.attr("data-disable-swipe")) && (E.disableSwipe = !0),
                            F(d.el.attr("data-hide-arrows")) ? (E.hideArrows = !0) : d.config.hideArrows && (d.left.show(), d.right.show()),
                ...
                function P(d, E, b) {
                    return function (h) {
                        if (E) d.hasFocus[b] = E;
                        else if (e.contains(d.el.get(0), h.relatedTarget) || ((d.hasFocus[b] = E), (d.hasFocus.mouse && b === "keyboard") || (d.hasFocus.keyboard && b === "mouse"))) return;
                        E ? (d.ariaLiveLabel.attr("aria-live", "polite"), d.hasTimer && k(d)) : (d.ariaLiveLabel.attr("aria-live", "off"), d.hasTimer && re(d));
                    };
                }
                function W(d, E) {
                    return function (b) {
                ...
                function x(d) {
                    return function (E, b) {
                        ...
                        if (E.type === "swipe") return h.disableSwipe || St.env("editor") ? void 0 : b.direction === "left" ? K(d)() : b.direction === "right" ? X(d)() : void 0;
                        if (d.nav.has(E.target).length) {
                            var j = e(E.target).index();
                            if ((E.type === "click" && H(d, { index: j }), E.type === "keydown"))
                                switch (E.keyCode) {
                                    case ft.ENTER:
                                    case ft.SPACE: {
                ...
                function H(d, E) {
                    ...
                    var j = E.index,
                        $ = {};
                    j < 0
                        ? ((j = h.length - 1), b.infinite && (($.x = -d.endX), ($.from = 0), ($.to = h[0].width)))
                        : j >= h.length && ((j = 0), b.infinite && (($.x = h[h.length - 1].width), ($.from = -h[h.length - 1].x), ($.to = $.from - $.x))),
                        (d.index = j);
                    var Q = d.nav.children().eq(j).addClass("w-active").attr("aria-pressed", "true").attr("tabindex", "0");
                    d.nav.children().not(Q).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"),
                    b.hideArrows && (d.index === h.length - 1 ? d.right.hide() : d.right.show(), d.index === 0 ? d.left.hide() : d.left.show());
                    var ue = d.offsetX || 0,
                    ...
                    if ((a || d.ariaLiveLabel.text(`Slide ${j + 1} of ${h.length}.`), V === "cross")) {
                    ...
                    if (V === "over") {
                        (oe = { x: d.endX }),
                            n(G).set({ visibility: "" }).stop(),
                            n(p)
                                .set({ visibility: "", zIndex: d.depth++, x: _e + h[d.index].width * He })
                                .add(_)
                                .start({ x: _e })
                                .then(T);
                        return;
                    ...
                    b.infinite && $.x
                        ? (n(d.slides.not(G)).set({ visibility: "", x: $.x }).add(_).start({ x: _e }), n(G).set({ visibility: "", x: $.from }).add(_).start({ x: $.to }), (d.shifted = G))
                        : (b.infinite && d.shifted && (n(d.shifted).set({ visibility: "", x: ue }), (d.shifted = null)), n(d.slides).set({ visibility: "" }).add(_).start({ x: _e }));
                    function T() {
                        (p = e(h[d.index].els)), (Y = d.slides.not(p)), V !== "slide" && (oe.visibility = "hidden"), n(Y).set(oe);
                    }
                }
                function B(d, E) {
                    var b = e.data(E, u);
                ...
                function ee(d) {
                    ...
                    Q < 0 && (Q = 0),
                        ...
                        d.slides.each(function (_e, oe) {
                            h - b > Q && (E++, (b += $), (d.anchors[E - 1] = { els: [], x: h, width: 0 })), (j = e(oe).outerWidth(!0)), (h += j), (d.anchors[E - 1].width += j), d.anchors[E - 1].els.push(oe);
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: { id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1708635333519,
        },
        "e-5": {
            id: "e-5",
            name: "",
            ...
            targets: [{ id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] }],
            config: [
                { continuousParameterGroupId: "a-2-p", selectedAxis: "X_AXIS", basedOn: "VIEWPORT", reverse: false, smoothing: 50, restingState: 50 },
                { continuousParameterGroupId: "a-2-p-2", selectedAxis: "Y_AXIS", basedOn: "VIEWPORT", reverse: false, smoothing: 50, restingState: 50 },
            ],
            createdOn: 1709151315618,
        },
        "e-7": {
            id: "e-7",
            name: "",
            ...
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeIn", autoStopEventId: "e-8" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".section", originalId: "65d7af2985a47be31f4304cf|0e64d75a-68e4-be54-9b5e-e062095d71e8", appliesTo: "CLASS" },
            targets: [{ selector: ".section", originalId: "085d41eb-2780-0f6f-3427-7bf56e77652e", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: true },
            createdOn: 1709216043931,
        },
        "e-8": {
            id: "e-8",
            name: "",
            ...
            action: { id: "", actionTypeId: "FADE_EFFECT", instant: false, config: { actionListId: "fadeOut", autoStopEventId: "e-7" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".section", originalId: "65d7af2985a47be31f4304cf|0e64d75a-68e4-be54-9b5e-e062095d71e8", appliesTo: "CLASS" },
            targets: [{ selector: ".section", originalId: "085d41eb-2780-0f6f-3427-7bf56e77652e", appliesTo: "CLASS" }],
        ...
        "e-11": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a8", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a8", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1709732123525,
        },
        "e-13": {
            id: "e-13",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786aa", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5787bfaf-7eff-ab9e-e58a-1bb9185786aa", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1709732417069,
        },
        "e-15": {
            id: "e-15",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ac", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ac", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1709732466697,
        },
        "e-17": {
            id: "e-17",
            name: "",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 9, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
            createdOn: 1709756839081,
        },
        "e-18": {
            id: "e-18",
            name: "",
            animationType: "custom",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-17" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-19": {
            ...
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-14", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] }],
            config: [{ continuousParameterGroupId: "a-14-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1709757849310,
        },
        "e-20": {
            id: "e-20",
            name: "",
            ...
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-15", affectedElements: {}, playInReverse: false, autoStopEventId: "e-21" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] },
            targets: [{ id: "65d7af2985a47be31f4304cf", appliesTo: "PAGE", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
            createdOn: 1709758402110,
        },
        "e-21": {
            id: "e-21",
            name: "",
        ...
        "e-22": {
            ...
            animationType: "preset",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInLeft", autoStopEventId: "e-23" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "085d41eb-2780-0f6f-3427-7bf56e77652e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "085d41eb-2780-0f6f-3427-7bf56e77652e", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 500, direction: "LEFT", effectIn: true },
            createdOn: 1709798700534,
        },
    },
    actionLists: {
        a: {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-n", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { id: "423f82d9-17e1-bfe8-507a-877275d2ada0" }, value: "flex" } },
                        { id: "a-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { id: "423f82d9-17e1-bfe8-507a-877275d2ada1" }, value: 0, unit: "" } },
                    ],
                },
                {
                    actionItems: [
                        { id: "a-n-5", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "inOutQuad", duration: 250, target: { id: "423f82d9-17e1-bfe8-507a-877275d2ada1" }, value: 1, unit: "" } },
                        { id: "a-n-6", actionTypeId: "TRANSFORM_MOVE", config: { delay: 500, easing: "inOutQuad", duration: 500, target: { id: "423f82d9-17e1-bfe8-507a-877275d2ada0" }, yValue: 100, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                    ],
                },
                { actionItems: [{ id: "a-n-3", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { id: "423f82d9-17e1-bfe8-507a-877275d2ada0" }, value: "none" } }] },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1708635359939,
        },
        "a-2": {
            id: "a-2",
            title: "Background Glow Follow",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".background-glow", selectorGuids: ["d87a91a5-7f42-2dff-0478-a9af6d005dec"] }, xValue: -50, xUnit: "vw", yUnit: "PX", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                            ...
                            actionItems: [
                                {
                                    id: "a-2-n-4",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { selector: ".background-glow", selectorGuids: ["d87a91a5-7f42-2dff-0478-a9af6d005dec"] }, yValue: -50, xUnit: "PX", yUnit: "vh", zUnit: "PX" },
                                },
                            ],
                        },
                        {
                    ...
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.kebab", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "d596c98b-f8d7-88d6-9c11-5c222bd108c6"] }, value: "block" },
                        },
                        {
                            id: "a-9-n-3",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.pizza", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "ea729748-3ba6-29ab-1975-676221cd713e"] }, value: "none" },
                        },
                        {
                            id: "a-9-n-4",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.grill", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "4924e8ec-fd85-58fd-8e6d-7b2c9c998b3f"] }, value: "none" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a8" }, globalSwatchId: "", rValue: 231, bValue: 231, gValue: 231, aValue: 1 },
                        },
                        {
                            id: "a-9-n-6",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a8" }, globalSwatchId: "", rValue: 0, bValue: 0, gValue: 0, aValue: 1 },
                        },
                        {
                            id: "a-9-n-8",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "SIBLINGS", selector: ".header-link", selectorGuids: ["ad1ae8c8-6efc-7def-0643-94a14632d494"] },
                                globalSwatchId: "--pro-white",
                                rValue: 239,
                                bValue: 247,
                                gValue: 242,
                                aValue: 1,
                    ...
                    actionItems: [
                        {
                            id: "a-10-n",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.kebab", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "d596c98b-f8d7-88d6-9c11-5c222bd108c6"] }, value: "none" },
                        },
                        {
                            id: "a-10-n-2",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.pizza", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "ea729748-3ba6-29ab-1975-676221cd713e"] }, value: "block" },
                        },
                        {
                            id: "a-10-n-3",
                            actionTypeId: "GENERAL_DISPLAY",
                    ...
                    actionItems: [
                        {
                            id: "a-10-n-4",
                            actionTypeId: "STYLE_BACKGROUND_COLOR",
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786aa" }, globalSwatchId: "", rValue: 231, bValue: 231, gValue: 231, aValue: 1 },
                        },
                        {
                            id: "a-10-n-5",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786aa" }, globalSwatchId: "", rValue: 0, bValue: 0, gValue: 0, aValue: 1 },
                        },
                        {
                            id: "a-10-n-7",
                            actionTypeId: "STYLE_TEXT_COLOR",
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-11-n-3",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { selector: ".type-subdiv.grill", selectorGuids: ["3be16bcf-3c8e-5416-47be-f1bd0ac9870d", "4924e8ec-fd85-58fd-8e6d-7b2c9c998b3f"] }, value: "block" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-11-n-4",
                            actionTypeId: "STYLE_BACKGROUND_COLOR",
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ac" }, globalSwatchId: "", rValue: 231, bValue: 231, gValue: 231, aValue: 1 },
                        },
                        {
                            id: "a-11-n-5",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 200, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ac" }, globalSwatchId: "", rValue: 0, bValue: 0, gValue: 0, aValue: 1 },
                        },
                        {
                            id: "a-11-n-7",
                            actionTypeId: "STYLE_TEXT_COLOR",
        ...
        "a-13": {
            id: "a-13",
            title: "Toggle navbar logo OFF",
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-13-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "outCubic", duration: 400, target: { useEventTarget: true, id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7" }, value: 0, unit: "" } },
                        {
                            id: "a-13-n-2",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7" }, xValue: -95, xUnit: "px", yUnit: "PX", zUnit: "PX" },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: false,
            createdOn: 1709757299255,
        },
        "a-12": {
            id: "a-12",
            title: "Toggle navbar logo on",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                        ...
                        { id: "a-12-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 200, target: { useEventTarget: true, id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7" }, value: 0, unit: "" } },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-12-n-3",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "outCirc", duration: 500, target: { useEventTarget: true, id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7" }, xValue: 0, xUnit: "px", yUnit: "PX", zUnit: "PX" },
                        },
                        { id: "a-12-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "outQuad", duration: 200, target: { useEventTarget: true, id: "5787bfaf-7eff-ab9e-e58a-1bb9185786a7" }, value: 1, unit: "" } },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1709756846113,
        },
        "a-14": {
            id: "a-14",
            title: "Animate Scrollbar",
            continuousParameterGroups: [
                {
                    id: "a-14-p",
                            ...
                            actionItems: [
                                {
                                    id: "a-14-n-5",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: -85, yValue: 0, zValue: 0, xUnit: "px", yUnit: "px", zUnit: "px" },
                                },
                                { id: "a-14-n-6", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: 0.1, yValue: 1, zValue: 1, locked: false } },
                            ],
                        },
                        {
                            keyframe: 18,
                            actionItems: [
                                { id: "a-14-n", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: 1, yValue: 1, zValue: 1, locked: true } },
                                {
                                    id: "a-14-n-4",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: 0, yValue: 0, zValue: 0, xUnit: "px", yUnit: "px", zUnit: "px" },
                                },
                            ],
                        },
                        {
                            keyframe: 100,
                            actionItems: [
                                { id: "a-14-n-2", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: 6.65, yValue: 1, zValue: 1, locked: false } },
                                {
                                    id: "a-14-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, xValue: 529, yValue: 0, zValue: 0, xUnit: "px", yUnit: "px", zUnit: "px" },
                                },
                            ],
                        },
                    ],
            ...
            createdOn: 1709757853324,
        },
        "a-15": {
            id: "a-15",
            title: "Brighten Scrollbar",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 500, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, filters: [{ type: "brightness", filterId: "ff34", value: 100, unit: "%" }] },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-15-n-2",
                            actionTypeId: "STYLE_FILTER",
                            config: { delay: 0, easing: "outQuad", duration: 160, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, filters: [{ type: "brightness", filterId: "5c40", value: 188, unit: "%" }] },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-15-n-3",
                            actionTypeId: "STYLE_FILTER",
                            config: { delay: 0, easing: "outQuad", duration: 600, target: { id: "5787bfaf-7eff-ab9e-e58a-1bb9185786ae" }, filters: [{ type: "brightness", filterId: "3d28", value: 100, unit: "%" }] },
                        },
                    ],
                },
            ],
            useFirstGroupAsInitialState: true,
            createdOn: 1709758417456,
        },
        fadeIn: {
            id: "fadeIn",
            useFirstGroupAsInitialState: true,
